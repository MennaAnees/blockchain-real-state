...
import "openzeppelin-solidity/contracts/utils/Address.sol"; //make sure of address is from contract or individual
import "openzeppelin-solidity/contracts/drafts/Counters.sol"; //protect overflow when inc and dec
import "openzeppelin-solidity/contracts/math/SafeMath.sol"; //safe addition and sub
...
contract Ownable {
    ...
    function transferOwnership(address newOwner) public onlyOwner {
        ...
        require(newOwner != address(0), "'account' must be a valid address.");
...
contract Pausable is Ownable {
    ...
    function setter(bool paused) public onlyOwner {
        _paused = paused;
    ...
    modifier paused() {
        require(_paused, "You need to pause the contract");
        _;
    }
...
contract ERC721 is Pausable, ERC165 {
    ...
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != owner, "You already own this token");
        require(
    ...
    function getApproved(uint256 tokenId) public view returns (address) {
        ...
        require(_exists(tokenId), "Token is not approved yet");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(
            ...
            "Fail to transfer, You don`t own this token"
        );
        require(to != address(0), "'to' isn`t a valid address");
